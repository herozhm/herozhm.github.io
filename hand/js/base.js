...
// 
// 	clearInterval(obj.timer); //首次加载清除定时器
// 
// 	var speed = obj.offsetLeft < target ? 10 : -10;
// 
// 	obj.timer = setInterval(function() {
// 		var result = target - obj.offsetLeft; //获得之间差值 -200
...
// 			// 直接跳到目标位置
// 			obj.style.left = target + "px"; //有10个像素值
// 		}
// 	}, 20)
// }
...
function animate(obj, json, callback) {
	...
	obj.timer = setInterval(function() {
		...
		// 对象循环
		for (attr in json) {
			// attr = top,left,width,height
			var current = parseInt(getStyle(obj, attr)); //属性值

			// json[attr] :目标距离     current = div 对象距离
